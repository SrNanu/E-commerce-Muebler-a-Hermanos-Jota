...
const getAllOrders = async (req, res) => {
  try {
    ...
    const { estado, page = 1, limit = 10, sort = '-createdAt' } = req.query;
    ...
    // Convertir el parámetro sort a formato de MongoDB
    // '-createdAt' = descendente (reciente), 'createdAt' = ascendente (antiguo)
    const sortObj = {};
    if (sort === '-createdAt') {
      sortObj.createdAt = -1;
